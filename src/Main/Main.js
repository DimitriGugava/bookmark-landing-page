  ...
  return (
    <div className="mainContainer">
      ...
      <div className="monitorImageBox2">
        {showBookmarking && <img className="monitor2" src={monitor2} />}
        {showwSearch && <img className="monitor2" src={speedysearching} />}
        {showwSharing && <img className="monitor2" src={easysharing} />}
      ...
      <div className="faq">
        ...
        <div className="faqListBox">
          ...
          <div className="questionAndAnswerBox">
            <div className="questionBox">
              <p className="questionText">How can I request a new browser?</p>
              {isRotated[1] ? (
                <img
                  className="arrowDown"
                  src={arrowBellow}
